...
<head>
  <style>
    ...
    .discord-button { display: inline-block; background-color: #000000; color: #ffffff; padding: 15px 35px; text-decoration: none; border-radius: 10px; font-weight: 600; font-size: 16px; }
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <p style="text-align: center; margin-top: 20px;">
        <a href="https://discord.gg/aXQevrYxBm" class="discord-button">
          <svg style="width: 18px; height: 18px; vertical-align: middle; margin-right: 8px; display: inline-block;" fill="currentColor" viewBox="0 0 24 24">
