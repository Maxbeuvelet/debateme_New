      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen px-4">
          ...
          >
            ...
            >
              <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-700/50 rounded-2xl overflow-hidden shadow-[0_0_50px_rgba(168,85,247,0.2)] relative">
                ...
                {/* Preview Content - Actual Home Page Layout */}
                <div className="opacity-50">
                  {/* Hero Section Preview with Video Background */}
                  <div className="relative h-[300px] md:h-[400px] overflow-hidden">
                    ...
                    >
                      <source src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68da9d2bed6a011bee1c2750/6bc7b0ab1_Comp%201_1.mp4" type="video/mp4" />
                    </video>
                    <div className="absolute inset-0 bg-gradient-to-b from-slate-900/50 via-slate-900/70 to-slate-900" />
                    <div className="relative h-full flex items-center justify-center">
                      <div className="text-center px-4">
                        <h1 className="text-4xl md:text-6xl font-black bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 bg-clip-text text-transparent mb-4">
                          DebateMe
                        </h1>
                        <p className="text-slate-300 text-lg md:text-xl mb-6">
                          Challenge perspectives through live debates
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="px-6 py-8 bg-slate-800/50">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      {[
                        { label: 'Active Topics', value: '42' },
                        { label: 'Live Debates', value: '18' },
                        { label: 'Total Arguments', value: '1.2K' },
                        { label: 'Debaters', value: '500+' }
                      ].map((stat) => (
                  ...
                  <div className="px-6 py-8 bg-slate-800/30">
                    <h2 className="text-2xl font-bold text-white mb-4">🔥 Trending Debates</h2>
                    <div className="flex gap-4 overflow-x-auto pb-2">
                      {[1, 2, 3].map((i) => (
                        <div key={i} className="bg-slate-700/50 rounded-xl p-4 min-w-[280px]">
                          <div className="text-sm font-bold text-cyan-400 mb-2">Politics</div>
                          <h3 className="text-white font-bold mb-2">Should AI replace human jobs?</h3>
                          <p className="text-xs text-slate-400">24 participants waiting</p>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  {/* Categories Preview */}
                  <div className="px-6 py-8 bg-slate-800/50">
                    <h2 className="text-2xl font-bold text-white mb-4">Browse Topics</h2>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      {['Politics', 'Technology', 'Environment', 'Economics'].map((cat) => (
                        <div key={cat} className="bg-slate-700/50 rounded-xl p-6 text-center">
                          <div className="text-3xl mb-2">🎯</div>
                          <div className="font-bold text-white">{cat}</div>
                          <div className="text-xs text-slate-400 mt-1">12 topics</div>
                        </div>
                      ))}
                    </div>
                  </div>
