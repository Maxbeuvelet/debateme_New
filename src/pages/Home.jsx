...
export default function Home() {
  // Launch date: Friday, January 2nd, 2026 at 7pm EST
  const LAUNCH_DATE = new Date(2026, 0, 2, 19, 0, 0).getTime(); // year, month (0=Jan), day, hour, min, sec
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              >
                ...
                <span className="text-cyan-300 text-lg font-semibold">Launching Friday, Jan 2nd at 7pm EST</span>
              </motion.div>
